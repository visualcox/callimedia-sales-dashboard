...
def page_product_analysis():
    ...
    # 제품 컬럼 찾기
    product_col = None
    for col in ['품목명', '제품명', '상품명', '품명', '품목', '제품', '상품', '아이템', '물품', 'Product', 'Item']:
        if col in df.columns:
            product_col = col
            break
    ...
    if not product_col:
        ...
        st.warning("📌 **찾고 있는 컬럼명**: 품목명, 제품명, 상품명, 품명, 품목, 제품, 상품, 아이템, 물품, Product, Item")
                    ...
                    if 'merged_sales_df' in st.session_state:
                        with st.spinner("매출 데이터에 브랜드 정보 추가 중..."):
                            ...
                            if product_col:
                                ...
                                st.error("📌 **찾고 있는 컬럼명**: 품목명, 제품명, 상품명, 품명, 품목, 제품, 상품, 아이템, 물품, Product, Item")
